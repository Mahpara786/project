...
//            System.err.println("File Path = "+propFile);
            Connection con = ConnectionProviderToDB.getConnectionObject().getConnection("C:\\Users\\HP\\Documents\\NetBeansProjects\\ExavaluInsuranceApplicationV2\\ExavaluInsuranceApplicationV2\\src\\java\\exavalu\\cofig\\db_params.properties");
            
            System.out.println("Connection established::"+con);
//Write SQL 
            String sql = "SELECT * FROM login_credentials where emailAddress=? and password=?";
